...
const sqlContent = `-- FlowWork CMMS 360 - Database Schema Design (For Supabase / PostgreSQL)
...
fs.writeFileSync('supabase-schema.sql', sqlContent, 'utf8');
console.log('Done writing schema');
